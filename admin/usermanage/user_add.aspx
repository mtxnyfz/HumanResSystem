<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_add.aspx.cs" Inherits="XMGL.Web.admin.user_add" %>
...
<body>
    ...
    <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        Title="SimpleForm" LabelWidth="150px" Width="300px" >
        ...
        <Rows>
            ...
            <Items>
                ...
                <%--<f:TextBox ID="TextBox_jgh" runat="server" Label="登录帐号(教工号)" Text="" Required="true" ShowRedStar="true">
                   ...
                   <f:TriggerBox ID="TextBox_jgh" EnableEdit="false" Text="" EnablePostBack="false"
                    TriggerIcon="Search" Label="登录帐号(教工号)" runat="server"> </f:TriggerBox>
            ...
            <Items>
                     ...
                     <f:TextBox ID="TextBox_name" runat="server" Label="姓名" Text="" Required="true" ShowRedStar="true"  Readonly="true">
                </f:TextBox>
