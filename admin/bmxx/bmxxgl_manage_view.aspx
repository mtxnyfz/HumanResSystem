<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bmxxgl_manage_view.aspx.cs" Inherits="HumanResSystem.Web.admin.bmxx.bmxxgl_manage_view" %>
    ...
    <form id="form1" runat="server">
      <f:PageManager ID="PageManager1" runat="server" AutoSizePanelID="Grid1"></f:PageManager>
        ...
        <f:Window ID="Window1" Title="" Hidden="true" EnableIFrame="true"
            ...
            IsModal="true" Width="450px" Height="300px" >
