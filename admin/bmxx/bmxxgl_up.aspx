<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bmxxgl_up.aspx.cs" Inherits="HumanResSystem.Web.admin.bmxx.bmxxgl_up" %>
...
<body>
    ...
    <f:PageManager ID="PageManager1" runat="server"></f:PageManager>
         <f:Form ID="Form2" MessageTarget="Qtip" Width="420px" BodyPadding="5px" Title="修改部门信息" ShowHeader="false"  ShowBorder="false" runat="server"  LabelAlign="Left">
            <items>
                <f:Panel ID="Panel1" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                    Layout="Column" runat="server">
                    <Items>
                          <f:TextBox ID="TextBox_bmdm"  Label="部门编号" Required="true" ShowRedStar="true"  CssClass="formitem" runat="server" Margin="10 15 0 15" ColumnWidth="70%" Enabled="false">
                        </f:TextBox>
                ...
                <f:Panel ID="Panel3" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                 ...
                 <f:Panel ID="Panel4" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                    ...
                    <Items>
                          ...
                          <f:DropDownList ID="DropDownList_bmsfyx" runat="server" Label="部门是否有效" Required="true" ShowRedStar="true"  CssClass="formitem" Margin="10 15 0 15" ColumnWidth="70%">
