<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jgxxgl_add.aspx.cs" Inherits="HumanResSystem.Web.admin.jgxxgl_add" %>
...
<body>
    <form id="form1" runat="server">
        <f:PageManager ID="PageManager1" runat="server"></f:PageManager>
         <f:Form ID="Form2" MessageTarget="Qtip" Width="600px" BodyPadding="5px" Title="添加教工信息" ShowHeader="false"  ShowBorder="false" runat="server"  LabelAlign="Top">
            <items>
                <f:Panel ID="Panel1" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                    Layout="Column" runat="server">
                    <Items>
                        
                        <f:TextBox ID="TextBox_gh"  Label="工号"   CssClass="formitem" runat="server" Enabled="false" Margin="10 15 0 15" ColumnWidth="50%" EmptyText="自动生成">
                        </f:TextBox>
                 ...
                 <f:Panel ID="Panel2" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                  ...
                  <f:Panel ID="Panel9" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                    Layout="Column" runat="server">
                    <Items>
                          <f:DropDownList ID="DropDownList_ryxz" Required="true" ShowRedStar="true" runat="server" Label="人员性质"  CssClass="formitem" Margin="10 15 0 15" ColumnWidth="50%">
                 ...
                 <f:Panel ID="Panel11" ShowHeader="false" CssClass="formitem" ShowBorder="false"
                    ...
                    <Items>
                       ...
                       <%--  <f:TextBox ID="TextBox1"  Label="备注"     CssClass="formitem" runat="server" Margin="10 15 0 15" ColumnWidth="80%">
                        ...
                        <f:TextArea ID="TextArea1" runat="server" Height="80px" Label="备注" Text="" Margin="10 15 0 15" ColumnWidth="50%"></f:TextArea>
                    </Items>
                </f:Panel>
                  </items>
              <Toolbars>
